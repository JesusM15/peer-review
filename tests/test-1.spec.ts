...
test('test', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Título del artículo' }).fill('');
  await page.getByRole('textbox', { name: 'Título del artículo' }).press('CapsLock');
  await page.getByRole('textbox', { name: 'Título del artículo' }).fill('P');
  await page.getByRole('textbox', { name: 'Título del artículo' }).press('CapsLock');
  await page.getByRole('textbox', { name: 'Título del artículo' }).fill('Prueba');
  await page.getByRole('textbox', { name: 'Título del artículo' }).press('CapsLock');
  await page.getByRole('textbox', { name: 'Título del artículo' }).fill('PruebaA');
  await page.getByRole('textbox', { name: 'Título del artículo' }).press('CapsLock');
  await page.getByRole('textbox', { name: 'Título del artículo' }).fill('PruebaArticulo');
